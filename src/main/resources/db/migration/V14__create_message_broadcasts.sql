...
CREATE TABLE broadcast_group_results (
    id                  UUID        PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX idx_message_broadcasts_user     ON message_broadcasts(user_id);
CREATE INDEX idx_message_broadcasts_structure ON message_broadcasts(structure_id);
CREATE INDEX idx_message_broadcasts_status   ON message_broadcasts(status);
CREATE INDEX idx_broadcast_results_broadcast ON broadcast_group_results(broadcast_id);
